...
```bash
git clone https://github.com/Oseoji101/AirBnB_clone
```
...
(hbnb) update User 1afa163d-486e-467a-8d38-3040afeaa1a1 email "nonso.kelvin8770@gmail.com"
...
## Authors
<details>
    <summary>Chukwunonso Onwuka</summary>
    <ul>
